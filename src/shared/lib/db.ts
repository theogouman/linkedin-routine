 ...
 * cookie de session (FR-015). C'est pourquoi il n'y a ni RLS ni clé publique —
 * les ajouter donnerait une fausse impression de défense alors que la seule
 * frontière réelle est l'authentification de l'app.
 *
